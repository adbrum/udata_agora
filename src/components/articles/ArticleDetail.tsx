...
const MOCK_ARTICLES = [
  ...
  },
  {
    ...
    fullContent:
      "O impacto económico dos dados abertos é inegável. Neste webinar, especialistas discutem como as empresas podem utilizar datasets públicos para inovar e criar novos modelos de negócio.",
    date: "01 de agosto de 2025",
  ...
  },
  {
    ...
    fullContent:
      "A visualização de dados é uma competência essencial na era da informação. Participe neste workshop para aprender técnicas básicas e avançadas de representação visual de dados públicos.",
    date: "01 de agosto de 2025",
...
export default function ArticleDetail({ rid }: ArticleDetailProps) {
  ...
  const displayTitle = isFigmaArticle
    ? "Uma retrospectiva da temporada de volta às aulas do data.gouv.fr - 3 meses de eventos focados em dados públicos."
    : article.title;
  const displayDate = isFigmaArticle ? "18.12.2025" : article.date;
  const displayDescription = isFigmaArticle
